        ...
        <div className={collapsed ? "mb-3 px-2" : "mb-3 px-3"}>
          <div className="space-y-0.5">
            ...
            <button
              ...
              title="Notifications"
              className={`w-full flex items-center gap-2.5 px-3 py-2 text-left transition-colors hover:bg-ink/4 rounded-badge`}>
              ...
              <div className="mb-3 shrink-0 px-3">
                <div className="space-y-0.5">
                  ...
                  <button
                    ...
                    className="w-full flex items-center gap-2.5 px-3 py-2.5 text-left transition-colors hover:bg-ink/4 rounded-badge">
                    <div className="relative shrink-0">
                      <BellIcon className="text-ink/35 size-[18px]" />
                      <UnreadBadge
                        count={notifUnreadCount}
