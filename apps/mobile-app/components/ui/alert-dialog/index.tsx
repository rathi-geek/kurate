...
const alertDialogContentStyle = tva({
  base: 'overflow-hidden rounded-lg border border-border bg-background p-6',
  parentVariants: {
    size: {
      xs: 'w-[60%] max-w-[360px]',
      sm: 'w-[70%] max-w-[420px]',
...
const alertDialogCloseButtonStyle = tva({
  base: 'group/alert-dialog-close-button z-10 rounded-sm p-2 outline-0 data-[focus-visible=true]:bg-background/10 web:cursor-pointer',
});
