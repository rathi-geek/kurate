...
const switchStyle = tva({
  base: 'data-[focus=true]:ring-indicator-primary disabled:cursor-not-allowed data-[invalid=true]:rounded-xl data-[invalid=true]:border-2 data-[invalid=true]:border-destructive data-[disabled=true]:opacity-40 data-[focus=true]:outline-0 data-[focus=true]:ring-2 web:cursor-pointer',
