  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'hard-4': '0px -3px 10px 0px rgba(13, 46, 71, 0.20)',
        'hard-5': '0px 2px 10px 0px rgba(13, 46, 71, 0.10)',
        'soft-1': '0px 0px 10px rgba(13, 46, 71, 0.1)',
        'soft-2': '0px 0px 20px rgba(13, 46, 71, 0.2)',
        'soft-3': '0px 0px 30px rgba(13, 46, 71, 0.1)',
        'soft-4': '0px 0px 40px rgba(13, 46, 71, 0.1)',
      },
    },
  },
};
